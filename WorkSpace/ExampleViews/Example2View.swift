...
class Example2View: UIView {
    ...
    @IBOutlet weak var maxMinTempt: UILabel!
    ...
    func commonInit() {
        ...
        if let view = Bundle.main.loadNibNamed("Example2", owner: self, options: nil)?.first as? UIView {
    ...
    func getInfo(weatherInfo: WeatherInfo) {
        ...
        self.maxMinTempt.text = "max:\(Int(weatherInfo.main.temp_max - 273.15))℃ min:\(Int(weatherInfo.main.temp_min - 273.15))℃"
    }
